    ...
    public static void main(String[] args) {
        ...
        switch(testCase){
            ...
            case 4:
                ...
                break;
            case 5:
                System.out.println("Testing Paldin class getters");
                System.out.println("Paldin - Health: " + paladin.getHealth());
                System.out.println("Paldin - Damage: " + paladin.getDamage());
                System.out.println("Paldin - Shield: " + paladin.getShield());
                break;
            case 6:
                ...
                break;
            case 7:
                System.out.println("Testing ressurection for Paladin");
                
                paladin.receiveDamage(40);
                System.out.println("Paladin after receiving 40 damage - Health: " + paladin.getHealth());
                
                paladin.resurrect();
                System.out.println("Paladin after ressurecting - Health: " + paladin.getHealth());
